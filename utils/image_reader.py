...
def p(arg1=None,arg2=None,arg3=None):
...
def read_labeled_image_list_1(data_dir, data_list):
    df = pd.read_csv(data_list)
    images = list(data_dir + df['img'])
    masks = list(data_dir + df['label'])
    edges = list(data_dir + df['edges'])
